local TestPageA = {}
TestPageA.__index = TestPageA

------------------------------------------------------------
-- Constructor
------------------------------------------------------------

function TestPageA.new()
...
function TestPageA:onEnter(params)

    self.lastInput =
        "PAGE ENTER"
end

function TestPageA:onExit()
end
...
function TestPageA:onInput(event)
...
function TestPageA:render(renderer)
